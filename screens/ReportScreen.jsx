...
const ReportScreen = ({ navigation }) => {
  ...
  const getFiltersNames = async () => {
       ...
       axios.get ("http://"+currentDomain+"/api/method/slnee_app.api.get_report_filters?name="+reportName).then((res)=>{
        ...
        // const res0 = await axios.get ("http://"+currentDomain+"/api/method/frappe.desk.query_report.run?report_name="+reportName+"&filters={\"company\":"+JSON.stringify(company)+"}")
  ...
  const getFilters = ()=>{
    const arr ={}
     ...
     filtersNames.map(async(filter)=>{
          ...
          axios.get("http://"+currentDomain+"/api/method/slnee_app.api.get_defaults?key="+filter.value).then((response)=>{
